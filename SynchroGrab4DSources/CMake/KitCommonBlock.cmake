...
IF(SynchroGrab4D_KITS)
  STRING(REGEX MATCH "${KIT}" already_have_kit ${SynchroGrab4D_KITS})
ELSE(SynchroGrab4D_KITS)
  SET(already_have_kit 0)
ENDIF(SynchroGrab4D_KITS)

IF(NOT already_have_kit)
  SET(SynchroGrab4D_KITS ${SynchroGrab4D_KITS} ${KIT}
    CACHE INTERNAL "SynchroGrab4D Kits" FORCE)
  
  SET(SynchroGrab4D_LIBRARIES ${SynchroGrab4D_LIBRARIES} vtk${KIT}
    CACHE INTERNAL "SynchroGrab4D libraries" FORCE)
  
  SET(SynchroGrab4D_INCLUDE_DIRS ${SynchroGrab4D_INCLUDE_DIRS} ${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_CURRENT_BINARY_DIR}
    CACHE INTERNAL "SynchroGrab4D libraries" FORCE)
